...
def main():
    ...
    if not filename:
        candidates = [
            r"C:\Users\Rakesh\OneDrive\Desktop\Attachments\AIAC\Lab 12\book.csv",
            r"C:\Users\Rakesh\OneDrive\Desktop\Attachments\AIAC\Lab 12\boooks(Ai).csv",
            r"C:\Users\Rakesh\OneDrive\Desktop\Attachments\AIAC\Lab 12\boooks(Ai).json",
        ]
