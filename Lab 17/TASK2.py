...
candidate_paths = [
    "financial_data.csv",
    r"C:\Users\Rakesh\OneDrive\Desktop\Attachments\AIAC\Lab 17\financial_data.csv",
]
for p in candidate_paths:
    ...
    raise FileNotFoundError(
        "CSV file not found. Please ensure 'financial_data.csv' exists in this folder or at the expected path.\n"
